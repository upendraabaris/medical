...
const {getRegion, getRegionById, addRegion, updateRegion, deleteRegion, deleteAllRegion} = require("../controllers/regionCtrl")
...
router.delete('/deleteAll/:id', staffMiddleware, deleteAllRegion, responseSend)
