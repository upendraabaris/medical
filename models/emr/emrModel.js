...
//  emr_id: { type: Number, required: true, unique: true },
  chief_complaint_id: { type: mongoose.Schema.Types.ObjectId, ref: 'ChiefComplaints'},
  medical_specialty_id: { type: mongoose.Schema.Types.ObjectId, ref: 'MedicalSpecialty'},
  emr_question: { type: String},
  emr_question_type_id: { type: mongoose.Schema.Types.ObjectId, ref: 'EmrQuestionType'},
